...
async function main() {
  ...
  const { certificate, logoUrl, qrUrl } = JSON.parse(Buffer.concat(chunks).toString())
  ...
  const doc = e(Document, {},
    e(Page, { size: 'A4', style: styles.page },
      e(View, { style: styles.borderPage },
        ...
        // QR code
        qrUrl ? e(View, { style: styles.qrRow },
          e(View, { style: styles.qrBlock },
            e(Image, { style: styles.qrImage, src: qrUrl }),
            e(Text, { style: styles.qrCaption }, 'Scan to verify authenticity')
          )
        ) : null
      )
    )
