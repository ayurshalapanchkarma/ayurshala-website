  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">Ayurshala Dashboard</h1>
          <p className="text-gray-600 dark:text-gray-300">Ayurveda and Panchakarma Center – Clinic Operations</p>
        </div>
