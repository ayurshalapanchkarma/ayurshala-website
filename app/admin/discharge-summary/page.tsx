    ...
    try {
      const res = await fetch('/api/admin/discharge-summary-pdf', {
        ...
        body: JSON.stringify({
          ...
          age: '45',
          sex: 'M',
          doa_date: new Date(booking.preferred_date).toLocaleDateString('dd-mm-yyyy'),
          doa_time: booking.preferred_time,
          dod_date: new Date(booking.preferred_date).toLocaleDateString('dd-mm-yyyy'),
          dod_time: '2:50 PM',
          nationality: 'Indian',
          address: '',
          diagnosis: '',
          complaints: [],
          history_present_days: '',
          past_history: 'No',
          past_history_details: '',
          medications_administered: [],
          day_of_therapy: '1',
          pradhan_vedna: [],
          vitals_admission_bp: '110/60',
          vitals_admission_hr: '88',
          vitals_admission_nadi: 'V3, P2, K1',
          oe_mala: 'Samyak',
          oe_mutra: 'Samyak',
          oe_jihwa: 'Samyak',
          oe_shuda: 'Samyak',
          ...
          therapies: [],
          investigations: '',
          findings_discharge: 'BP- 118/68 mmHg, Pulse- 72/Min, Spo2-98%-RA',
          condition_discharge: 'Tolerated the treatments moderately well. Positive response.',
          advice_discharge: 'Advised to continue the medicines with Diet as advised, report the condition periodically.',
          medicine_discharge: 'Cont same treatment',
          medications_table: [],
          cautions: '',
          pathya: 'Bath with warm water/ Hot and fresh meal/ More fibrous food/low fat diet.',
          apathya: 'Avoid Curd/Cold water/ extreme cold exposure/ Day time sleeping.',
          doctor_name: booking.doctor_name || booking.doctor || '',
          doctor_mobile: '9821224767',
