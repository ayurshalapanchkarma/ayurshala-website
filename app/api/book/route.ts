    ...
    try {
      ...
      const emails: Promise<any>[] = [
        resend.emails.send({
          ...
          html: `<!DOCTYPE html><html><head><meta charset="utf-8"></head><body style="margin:0;padding:0;background:#FFF3E0;font-family:Arial,sans-serif"><table width="100%" cellpadding="0" cellspacing="0" style="background:#FFF3E0;padding:32px 16px"><tr><td align="center"><table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;border-radius:24px;overflow:hidden;background:#ffffff;border:1px solid rgba(232,98,26,0.18);box-shadow:0 8px 40px rgba(232,98,26,0.10)"><tr><td style="background:linear-gradient(135deg,#fff8f0,#ffe8d0);padding:36px 40px;text-align:center;border-bottom:1px solid rgba(232,98,26,0.15)"><img src="https://ayurshala-website.vercel.app/ayurshala_text.png" alt="Ayurshala" width="200" style="height:auto;display:block;margin:0 auto 12px"/><h1 style="margin:0;font-family:Georgia,serif;font-size:22px;font-weight:400;color:#1a1008">New Appointment Request</h1></td></tr><tr><td style="padding:36px 40px"><table width="100%" cellpadding="0" cellspacing="0" style="background:#fff8f0;border-radius:14px;border:1px solid rgba(232,98,26,0.12)"><tr><td style="padding:14px 20px;border-bottom:1px solid rgba(232,98,26,0.08)"><span style="font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#a8a29e">Name</span><br><span style="font-size:15px;color:#1a1008;font-weight:600">${name}</span></td></tr><tr><td style="padding:14px 20px;border-bottom:1px solid rgba(232,98,26,0.08)"><span style="font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#a8a29e">Phone</span><br><span style="font-size:15px;color:#1a1008">${phone}</span></td></tr><tr><td style="padding:14px 20px;border-bottom:1px solid rgba(232,98,26,0.08)"><span style="font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#a8a29e">Email</span><br><span style="font-size:15px;color:#1a1008">${email || '—'}</span></td></tr><tr><td style="padding:14px 20px;border-bottom:1px solid rgba(232,98,26,0.08)"><span style="font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#a8a29e">Treatment</span><br><span style="font-size:15px;color:#E8621A;font-weight:600">${treatment}</span></td></tr><tr><td style="padding:14px 20px;border-bottom:1px solid rgba(232,98,26,0.08)"><span style="font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#a8a29e">Date &amp; Time</span><br><span style="font-size:15px;color:#1a1008">${date || '—'} ${time ? '· ' + time : ''}</span></td></tr><tr><td style="padding:14px 20px;border-bottom:1px solid rgba(232,98,26,0.08)"><span style="font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#a8a29e">Concern</span><br><span style="font-size:15px;color:#1a1008">${concern || '—'}</span></td></tr><tr><td style="padding:14px 20px"><span style="font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#a8a29e">Payment</span><br><span style="font-size:15px;color:#1a1008">${isPaid ? `✓ Paid ₹${paidAmount} · Order: ${cashfreeOrderId}` : 'Cash on Arrival'}</span></td></tr></table></td></tr><tr><td style="padding:20px 40px;text-align:center;background:#fffaf5"><p style="margin:0 0 4px;font-size:12px;color:#78716c">SP-28, Wajidpur, Sector-130, Noida — 201301</p><p style="margin:0;font-size:11px;color:#c4bdb5">© 2026 Ayurshala Panchakarma Center</p></td></tr></table></td></tr></table></body></html>`,
        }),
      ]
