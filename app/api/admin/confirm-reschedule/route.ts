...
export async function GET(req: NextRequest) {
  ...
  await supabase.from('bookings_new').update({ status: 'CONFIRMED', preferred_date: booking.new_date, preferred_time: booking.new_time, is_rescheduled: true, rescheduled_at: new Date().toISOString(), old_date: null, old_time: null, new_date: null, new_time: null, updated_at: new Date().toISOString() }).eq('booking_id', booking_id)
