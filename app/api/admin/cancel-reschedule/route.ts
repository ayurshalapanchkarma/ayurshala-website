...
export async function GET(req: NextRequest) {
  ...
  return new NextResponse(`<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Reschedule Declined</title></head><body style="margin:0;padding:0;background:linear-gradient(135deg,#fdf6ee,#ffecd2);font-family:Arial,sans-serif;min-height:100vh;display:flex;align-items:center;justify-content:center;padding:16px"><div style="max-width:480px;width:100%;background:#fff;border-radius:24px;overflow:hidden;box-shadow:0 8px 40px rgba(232,98,26,0.12);border:1px solid rgba(232,98,26,0.2)"><div style="background:linear-gradient(135deg,#fee2e2,#fecaca);padding:32px 40px;text-align:center;border-bottom:1px solid rgba(220,38,38,0.15)"><img src="https://ayurshala-website.vercel.app/ayurshala_text.png" alt="Ayurshala" width="160" style="height:auto;margin-bottom:16px;display:block;margin-left:auto;margin-right:auto"/><h1 style="margin:0;font-family:Georgia,serif;font-size:22px;color:#dc2626">Reschedule Request Declined</h1><p style="margin:8px 0 0;font-size:13px;color:#6b7280">Patient notified of cancellation</p></div><div style="padding:32px 40px"><p style="font-size:13px;color:#78716c;margin:0 0 24px">The reschedule request for this booking has been declined. The patient's original appointment remains active and unchanged.</p><table width="100%" cellpadding="0" cellspacing="0" style="background:#fef2f2;border-radius:14px;border:1px solid rgba(220,38,38,0.12);margin-bottom:24px"><tr><td style="padding:12px 20px;border-bottom:1px solid rgba(220,38,38,0.08)"><span style="font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#a8a29e">Patient</span><br><span style="font-size:15px;color:#1a1008;font-weight:600">${patient?.full_name}</span></td></tr><tr><td style="padding:12px 20px;border-bottom:1px solid rgba(220,38,38,0.08)"><span style="font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#a8a29e">Booking ID</span><br><span style="font-size:15px;color:#dc2626">${booking_id}</span></td></tr><tr><td style="padding:12px 20px"><span style="font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#a8a29e">Original Appointment</span><br><span style="font-size:15px;color:#1a1008;font-weight:600">${formattedDate} · ${booking.preferred_time}</span></td></tr></table><div style="display:flex;gap:12px;margin-top:24px"><a href="https://www.ayurshalapanchakarma.com/admin" style="flex:1;display:inline-block;background:#E8621A;color:#fff;padding:12px;border-radius:12px;text-decoration:none;font-size:13px;font-weight:600;text-align:center">Back to Dashboard</a></div></div></div></body></html>`, { status: 200, headers: { 'Content-Type': 'text/html; charset=utf-8' } })
}
