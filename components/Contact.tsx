...
export default function Contact() {
  ...
  return (
    <>
      ...
      <footer className="border-t border-stone-100 py-5 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-2 mb-2">
            <Image src="/ayurshala_text_transparent.png" alt="Ayurshala" width={280} height={80} className="object-contain h-16 w-auto" />

            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/ayurshala" target="_blank" rel="noopener noreferrer"
                aria-label="Instagram"
                className="w-9 h-9 glass rounded-full flex items-center justify-center text-stone-400 hover:text-brand hover:border-brand/40 transition-all duration-300">
              ...
              <a href="https://www.facebook.com/ayurshala" target="_blank" rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-9 h-9 glass rounded-full flex items-center justify-center text-stone-400 hover:text-brand hover:border-brand/40 transition-all duration-300">
                <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
            ...
            <div className="flex gap-6">
              <a href="tel:+919821224767" className="font-sans text-xs text-stone-400 hover:text-brand transition-colors">Call Us</a>
              <a href="mailto:ayurshalapanchkarma@gmail.com" className="font-sans text-xs text-stone-400 hover:text-brand transition-colors">Email</a>
              <a href="/book" className="font-sans text-xs text-stone-400 hover:text-brand transition-colors">Book</a>
            </div>
          </div>
