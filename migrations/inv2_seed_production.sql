...
DELETE FROM inv_units WHERE true;  -- Clear existing data (optional, comment out to preserve)
...
DELETE FROM inv_categories WHERE true;  -- Clear existing data
...
DELETE FROM inv_manufacturers WHERE true;  -- Clear existing data
...
DELETE FROM inv_suppliers WHERE true;  -- Clear existing data
...
DELETE FROM inv_tax_master WHERE true;  -- Clear existing data
...
DELETE FROM inv_warehouses WHERE true;  -- Clear existing data
