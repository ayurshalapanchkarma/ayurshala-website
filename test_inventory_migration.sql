-- Test each CREATE TABLE statement individually
-- to identify the first failure

-- SECTION 1: inventory_categories (should work)
...
-- SECTION 2: inventory_products (likely to fail?)
...
-- SECTION 7: inventory_audit_logs
...
-- SECTION 10: purchase_order_items
...
-- SECTION 11: goods_receipt_notes (GRN)
...
-- SECTION 19: All remaining indexes
...
-- All tests passed!
SELECT 'Migration test complete - all sections executed' as status;
